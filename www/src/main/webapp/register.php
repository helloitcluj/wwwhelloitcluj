...
$mgClient = new Mailgun('key-841dd937c45ce511459d567a8b6e70ca-test');
$domain = "sandbox2c4deebb987b400a829e4b5e6723b413.test.mailgun.org";

# Make the call to the client.
$result = $mgClient->sendMessage($domain,
    array('from'    => 'Mailgun Sandbox <postmaster@sandbox2c4deebb987b400a829e4b5e6723b413.test.mailgun.org>',
